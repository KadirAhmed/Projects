...
public class MathEvaluator
{
 ...
 //  private 			HashMap	 	variables  	= new HashMap();
    ...
    private static Double evaluateExpression(Operator o, Double f1, Double f2)
    {
        ...
        Formatted format = new Formatted();
   ...
   //   else if  ( "^".equals(op) )  	res = new Double( pow_log.pow(f1.doubleValue(), f2.doubleValue()) );

        else if  ( "^".equals(op) )
            
        {
  
          Real power= new Real( format.GetFormatted(f1.doubleValue()+""));
              power.pow(new Real(format.GetFormatted(f2.doubleValue()+"")));

            res = new Double(Double.parseDouble(power.toString()));
        ...
        else if  ( "cos".equals(op) )
        {
          ...
          if((r==true) && (d==false) && (g==false)) { res = new Double( Math.cos(f1.doubleValue()));}
          else if((r==false) && (d==true) && (g==false)){ res = new Double(Math.cos(f1.doubleValue()*Math.PI/180));}
          else if((r==false) && (d==false)&& (g==true)){  res = new Double(Math.cos(f1.doubleValue()*Math.PI*.9/180));}
        
        }

        else if  ( "sin".equals(op) )
        {
            if((r==true) && (d==false) && (g==false)) {  res = new Double( Math.sin(f1.doubleValue()));}
          else if((r==false) && (d==true) && (g==false)){res = new Double( Math.sin(f1.doubleValue()*Math.PI/180));}
          else if((r==false) && (d==false)&& (g==true)){ res = new Double( Math.sin(f1.doubleValue()*Math.PI*.9/180));}
        }

        else if  ( "tan".equals(op) )
        {
             if((r==true) && (d==false) && (g==false)) { res = new Double( Math.tan(f1.doubleValue()));}
          else if((r==false) && (d==true) && (g==false)){ res = new Double(Math.tan(f1.doubleValue()*Math.PI/180));}
          else if((r==false) && (d==false)&& (g==true)){  res = new Double(Math.tan(f1.doubleValue()*Math.PI*.9/180));}
        }
        else if  ( "one".equals(op) )

        {

               if((r==true) && (d==false) && (g==false))
                 {
                    Real acos= new Real( format.GetFormatted(f1.doubleValue()+""));
                    acos.acos();
                    res = new Double(Double.parseDouble(acos.toString()));
                 }

               else if((r==false) && (d==true) && (g==false))
                 {
                    Real acos= new Real( format.GetFormatted(f1.doubleValue()+""));
                    acos.acos();
                    res = new Double(  (180/Math.PI)* Double.parseDouble(acos.toString()));
                 }

              else if((r==false) && (d==false) && (g==true))
                 {
                    Real acos= new Real( format.GetFormatted(f1.doubleValue()+""));
                    acos.acos();
                    res = new Double(  (200/(Math.PI))* Double.parseDouble(acos.toString()));
                 }

        }


       else if  ( "two".equals(op) )

        {
                  if((r==true) && (d==false) && (g==false))
                 {
                    Real asin= new Real( format.GetFormatted(f1.doubleValue()+""));
                    asin.asin();
                    res = new Double(Double.parseDouble(asin.toString()));
                 }
               ...
               else if((r==false) && (d==true) && (g==false))
                 {
                    Real asin= new Real( format.GetFormatted(f1.doubleValue()+""));
                    asin.asin();
                    res = new Double(  (180/Math.PI)* Double.parseDouble(asin.toString()));
                 }
              ...
              else if((r==false) && (d==false) && (g==true))
                 {
                    Real asin= new Real( format.GetFormatted(f1.doubleValue()+""));
                    asin.asin();
                    res = new Double(  (200/(Math.PI))* Double.parseDouble(asin.toString()));
                 }

        }

      else if  ( "three".equals(op) )
            
        {
                 if((r==true) && (d==false) && (g==false))
                 {
                    Real atan= new Real( format.GetFormatted(f1.doubleValue()+""));
                    atan.atan();
                    res = new Double(Double.parseDouble(atan.toString()));
                 }
               ...
               else if((r==false) && (d==true) && (g==false))
                 {
                    Real atan= new Real( format.GetFormatted(f1.doubleValue()+""));
                    atan.atan();
                    res = new Double(  (180/Math.PI)* Double.parseDouble(atan.toString()));
                 }
              ...
              else if((r==false) && (d==false) && (g==true))
                 {
                    Real atan= new Real( format.GetFormatted(f1.doubleValue()+""));
                    atan.atan();
                    res = new Double(  (200/(Math.PI))* Double.parseDouble(atan.toString()));
                 }
            
            
        }

          else if  ( "four".equals(op) )

        {
            Real aln= new Real( format.GetFormatted(f1.doubleValue()+""));
            aln.exp();
            res = new Double(Double.parseDouble(aln.toString()));


        }
          else if  ( "five".equals(op) )

        {
            Real alog= new Real( format.GetFormatted(f1.doubleValue()+""));  
            alog.exp10();

            res = new Double(Double.parseDouble(alog.toString()));
        ...
        else if  ( "ln".equals(op) )  	
        {
            ...
            // res = new Double( MathUtil.log(f1.doubleValue()) );

                Real ln= new Real( format.GetFormatted(f1.doubleValue()+""));
                ln.ln();

                res = new Double(Double.parseDouble(ln.toString()));
     ...
     //   else if  ( "rnd".equals(op) ) 	res = new Double( Math.random() * f1.doubleValue() );
        ...
        else if  ( "!".equals(op) )
        {
          ...
          Real fact= new Real( format.GetFormatted(f1.doubleValue()+""));
               fact.fact();

            res = new Double(Double.parseDouble(fact.toString()));
        ...
        {
           // res= new Double(MathUtil.log(f1.doubleValue())/2.3025850929940456840179914546844);


            Real log= new Real( format.GetFormatted(f1.doubleValue()+""));
               log.log10();

            res = new Double(Double.parseDouble(log.toString()));

        }

        else if  ( "Sinh".equals(op) )
        {

          //  res=  new Double(.5 * ( MathUtil.exp(f1.doubleValue()) -  MathUtil.exp(-f1.doubleValue()) ));
             Real Sinh= new Real( format.GetFormatted(f1.doubleValue()+""));
               Sinh.sinh();

            res = new Double(Double.parseDouble(Sinh.toString()));



        }
        else if  ( "Cosh".equals(op) )
        {

               // res=  new Double(.5 * ( MathUtil.exp(f1.doubleValue()) +  MathUtil.exp(-f1.doubleValue()) ));

             Real Cosh= new Real( format.GetFormatted(f1.doubleValue()+""));
               Cosh.cosh();

            res = new Double(Double.parseDouble(Cosh.toString()));

        }

            else if  ( "Tanh".equals(op) )
        {

               /*
                res=  new Double( ( MathUtil.exp(2* f1.doubleValue()) -  MathUtil.exp(2* -f1.doubleValue()) )
                                                              /
                                  ( MathUtil.exp(2* f1.doubleValue()) +  MathUtil.exp(2* -f1.doubleValue()) )
                                );
              ...
              Real Tanh= new Real( format.GetFormatted(f1.doubleValue()+""));
               Tanh.tanh();

            res = new Double(Double.parseDouble(Tanh.toString()));
    ...
    private void initializeOperators()
    {
        ...
        operators[16] = new Operator("ln" 	, 1, 20);
        ...
        operators[25] = new Operator("!"  , 2, 20);

        operators[26] = new Operator("log"  , 1, 20);

        operators[27] = new Operator("Sinh"  , 1, 20);

        operators[28] = new Operator("Cosh"  , 1, 20);

        operators[29] = new Operator("Tanh"  , 1, 20);

        operators[30] = new Operator("one"  , 1, 20);
        operators[31] = new Operator("two"  , 1, 20);
        operators[32] = new Operator("three"  , 1, 20);
        operators[33] = new Operator("four"  , 1, 20);
        operators[34] = new Operator("five"  , 1, 20);
    }
