...
public class Game extends MIDlet implements CommandListener
{
   ...
   // public static String  about_help;
    ...
    public Game()
    {
        ...
        // licensing info.
        licenseForm = new Form("StarWar");
        /*
        licenseForm.append("Fire-Fire"+"\n"+
                           "Right - Ship Rotate Clockwise"+"\n"+
                           "Left - Ship Rotate Anti-Clockwise"+"\n"+
                           "Up - Increase Accelaration"+"\n"+
                           "Down - Decrease Accelaration");
        */
        ...
        _licenseCommand = new Command("Help", Command.SCREEN, 3);

         About = new Command("About", Command.SCREEN, 3);

        field.addCommand(_exitCommand);
          field.addCommand(About);
       ...
       if (c == _exitCommand) {
          ...
          licenseForm.append("Fire-Fire"+"\n"+
           ...
           setDisplayable(licenseForm);
       	   ...
       	   field.setFrozen(true);
                     licenseForm.append("Developer: Walton Mobile,Bangladesh."+"\n\n"+
                                        "All Rights Reserved. "+
                                        "This application or parts thereof,"+
                                        "must not be used or reproduced in any manner "+
                                        "without return permission."+"\n\n"+
                                        "Address: R B Group, Jibon Bima Tower(Level-12),10,Dilkusha,Dhaka-1000,Bangladesh"+"\n\n"+
